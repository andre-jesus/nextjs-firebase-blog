  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Read posts by ${author.name}`} />
      </Head>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
          <div className="md:flex items-center">
            <div className="md:w-1/4 flex justify-center mb-4 md:mb-0">
              <div className="w-32 h-32 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-700 dark:text-blue-300 overflow-hidden">
                {author.profileImageUrl ? (
                  ...
                  <span className="text-4xl">{getInitials(author.name)}</span>
                )}
              </div>
            </div>
            ...
            <div className="md:w-3/4 md:pl-6">
              ...
              {author.jobTitle && (
                <p className="text-gray-600 dark:text-gray-300 text-lg mb-2">{author.jobTitle}</p>
              )}
              ...
              {author.bio && (
                <p className="text-gray-700 dark:text-gray-200 mb-4">{author.bio}</p>
              )}
              ...
              <div className="flex space-x-4">
                ...
                {author.socialLinks?.github && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white flex items-center"
                  >
                    <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
