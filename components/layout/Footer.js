      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-gray-900 dark:text-white">Happen</span>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Discover and join exciting events near you. Connect with friends, explore new experiences, and create unforgettable moments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/map" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                  Event Map
                </Link>
              </li>
              <li>
                <Link href="/events" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                  Browse Events
                </Link>
              </li>
              <li>
                <Link href="/venues" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                  Venues
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            &copy; {currentYear} Happen. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
